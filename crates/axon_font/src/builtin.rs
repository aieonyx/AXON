...
// Builtin 8x8 sovereign pixel font.
// Each glyph is 8 bytes — one byte per row, MSB = leftmost pixel.
// ASCII printable range 0x20-0x7E embedded. No external file dependency.
// Clean-room: pixel patterns drawn from scratch for AIEONYX.
// Copyright (c) 2026 Edison Lepiten / AIEONYX — original artwork.
use crate::glyph::Glyph;

pub fn builtin_glyph(codepoint: u32) -> Option<Glyph> {
    let bitmap = match codepoint {
        0x20 => [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00], // space
        0x21 => [0x18,0x18,0x18,0x18,0x00,0x00,0x18,0x00], // !
        0x22 => [0x66,0x66,0x00,0x00,0x00,0x00,0x00,0x00], // "
        0x23 => [0x36,0x36,0x7f,0x36,0x7f,0x36,0x36,0x00], // #
        0x24 => [0x0c,0x3e,0x0c,0x1e,0x0c,0x3e,0x0c,0x00], // $
        ...
        0x34 => [0x06,0x0e,0x1e,0x36,0x7f,0x06,0x06,0x00], // 4
        ...
        0x51 => [0x3c,0x66,0x66,0x66,0x6e,0x3c,0x06,0x00], // Q
        ...
        0x5c => [0x00,0x60,0x30,0x18,0x0c,0x06,0x00,0x00], // backslash
        ...
        0x6d => [0x00,0x00,0x36,0x7f,0x6b,0x63,0x63,0x00], // m
        ...
        0x76 => [0x00,0x00,0x66,0x66,0x3c,0x3c,0x18,0x00], // v
        0x77 => [0x00,0x00,0x63,0x6b,0x7f,0x36,0x36,0x00], // w
        ...
        0x7e => [0x00,0x00,0x32,0x4e,0x00,0x00,0x00,0x00], // ~
        _    => return None,
    };
    Some(Glyph::new(codepoint, bitmap))
}

pub fn builtin_glyph_count() -> usize { 95 } // 0x20..=0x7E
